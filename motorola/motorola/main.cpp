...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Bioinformatyka", WS_OVERLAPPEDWINDOW, 30, 30, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, wc.hInstance, NULL);
    ...
    builder.AddChar(0x107);
    builder.AddChar(0x118);
    builder.AddChar(0x119);
    builder.AddChar(0x141);
    builder.AddChar(0x142);
    builder.AddChar(0x143);
